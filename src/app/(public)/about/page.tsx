...
export default function AboutPage() {
  ...
  return (
    <div>
      <section className="pt-28 pb-20 px-6 seal-watermark seal-watermark-right">
      ...
      <section className="py-20 px-6 bg-paper texture-paper">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="space-y-4 text-sm text-gray-600 leading-relaxed max-w-2xl">
            ...
            <p>We represent 14 disciplines across 9 provinces: authors, translators, designers, narrators, publishers, editors, indexers, proofreaders, legal &amp; IP professionals, literary agents, photographers, layout designers, R&amp;D, and AI &amp; software developers.</p>
          </div>
